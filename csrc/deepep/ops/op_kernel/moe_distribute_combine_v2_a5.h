    ...
    TPipe *pipe, const MoeDistributeCombineV2TilingData *tilingData)
{
    ...
    // totalWinSize_, realWinSize, baseWindSize_);
    ...
    // printf("1.3 [RANK %d AIC %d] Combine Init dataState_ %d winDataSizeOffset_ %d winStatusOffset_ %d epWindowGM_
...
__aicore__ inline void MoeDistributeCombineV2A5<TemplateMC2TypeFunc>::LocalWindowCopy()
{
    ...
    // beginIndex, endIndex, processLen);
    SyncFunc<AscendC::HardEvent::MTE2_S>();
